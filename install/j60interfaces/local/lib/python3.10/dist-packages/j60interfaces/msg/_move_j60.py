...
class Metaclass_MoveJ60(type):
    """Metaclass of message 'MoveJ60'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'j60interfaces.msg.MoveJ60')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__move_j60
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__move_j60
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__move_j60
            cls._TYPE_SUPPORT = module.type_support_msg__msg__move_j60
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__move_j60
...
class MoveJ60(metaclass=Metaclass_MoveJ60):
    """Message class 'MoveJ60'."""
