...
bool j60interfaces__msg__state_j60__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j60interfaces.msg._state_j60.StateJ60", full_classname_dest, 37) == 0);
  }
  j60interfaces__msg__StateJ60 * ros_message = _ros_message;
  {  // motor_id
...
{
  /* NOTE(esteve): Call constructor of StateJ60 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j60interfaces.msg._state_j60");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StateJ60");
