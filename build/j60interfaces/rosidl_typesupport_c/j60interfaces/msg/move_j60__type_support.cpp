...
static const _MoveJ60_type_support_symbol_names_t _MoveJ60_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, j60interfaces, msg, MoveJ60)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, j60interfaces, msg, MoveJ60)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, j60interfaces, msg, MoveJ60)() {
  return &::j60interfaces::msg::rosidl_typesupport_c::MoveJ60_message_type_support_handle;
}
